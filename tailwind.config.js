...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'button-medium-primary': '0px 2px 20px -2px hsla(var(--primary)), 0px 0px 10px -4px hsla(var(--primary))',
        'button-medium-destructive':
          '0px 2px 20px -2px hsla(var(--destructive)), 0px 0px 10px -4px hsla(var(--destructive))',
        'button-small-primary': '0px 2px 10px -2px hsla(var(--primary)), 0px 0px 5px -4px hsla(var(--primary))',
